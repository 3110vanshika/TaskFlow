        ...
        <div className="flex flex-wrap">
            <div className="flex w-full flex-col md:w-1/2">
                ...
                <div className="lg:w-[28rem] mx-auto my-auto flex flex-col justify-center pt-8 md:justify-start md:px-6 md:pt-0">
                    ...
                    <p className="mt-2 text-left text-gray-500">Please enter your details to sign in and continue managing your tasks with AI-powered productivity.</p>
                    ...
                    <form className="flex flex-col pt-3 md:pt-8">
                        ...
                        <button type="submit" className="w-full cursor-pointer rounded-lg bg-gray-900 px-4 py-2 text-center text-base font-semibold text-white shadow-md ring-gray-500 ring-offset-2 transition focus:ring-2">Sign in</button>
                    </form>
