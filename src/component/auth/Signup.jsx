        ...
        <div className="flex flex-wrap">
            <div className="flex w-full flex-col md:w-1/2">
                ...
                <div className="lg:w-[28rem] mx-auto my-auto flex flex-col justify-center pt-8 md:justify-start md:px-6 md:pt-0">
                    ...
                    <p className="mt-2 text-left text-gray-500">Please create your account & start managing your tasks smarter with AI. </p>
                    <button className="-2 mt-8 cursor-pointer flex items-center justify-center rounded-md border px-4 py-1 outline-none ring-gray-400 ring-offset-2 transition focus:ring-2 hover:border-transparent hover:bg-black hover:text-white"><img className="mr-2 h-5" src="https://static.cdnlogo.com/logos/g/35/google-icon.svg" alt /> Log in with Google</button>
                    ...
                    <form className="flex flex-col pt-3 md:pt-8">
                        <div className="flex flex-col pt-4">
                            <div className="focus-within:border-b-neutral-300 relative flex overflow-hidden border-b-2 transition">
                                <input type="text" id="username" className="w-full flex-1 appearance-none border-neutral-300 bg-white px-4 py-2 text-base text-gray-700 placeholder-neutral-400 focus:outline-none" placeholder="Username" />
                            </div>
                        </div>
                        <div className="flex flex-col pt-4">
                        ...
                        <button type="submit" className="w-full rounded-lg cursor-pointer bg-gray-900 px-4 py-2 text-center text-base font-semibold text-white shadow-md ring-gray-500 ring-offset-2 transition focus:ring-2">Signup</button>
                    </form>
                    <div className="py-12 text-center">
                        <p className="whitespace-nowrap text-gray-600">
                            Don't have an account?
                            <Link to='/' className="underline-offset-4 font-semibold text-gray-900 underline ml-2">Sign in </Link>
                        </p>
                    </div>
                </div>
            </div>
